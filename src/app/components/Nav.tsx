...
const Nav = () => {
  ...
  return (
    <header className="bg-white dark:bg-gray-900 px-16">
        <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="md:flex md:items-center md:gap-12">
                ...
                <ul className="flex items-center gap-6 text-sm">
                    ...
                    <li onClick={() => setIsDropdownOpen(!isDropdownOpen)} className='flex items-center'>
                    <button
                        className="text-gray-500 transition hover:text-gray-500/75 dark:text-white dark:hover:text-white/75"
                    >
                        Grades
                  ...
                  >
                    ...
                    {isDropdownOpen && (
                        ...
                        <div
                            className="absolute end-0 z-10 mt-5 w-56 divide-y divide-gray-100 rounded-md border border-gray-100 bg-white shadow-lg dark:divide-gray-800 dark:border-gray-800 dark:bg-gray-900"
                            role="menu"
                        >
                            <div className="p-2">
